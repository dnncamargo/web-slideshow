...
export function createDefaultGradient(type: Gradient["type"]): Gradient {
  if (type === "linear") {
    return {
      type,
...
// ============================================================
// BEGIN: ELEMENT GRADIENT CONTROL
// ============================================================
