import type { ContainerElement, PowerShowElement, TextElement, TextboxElement } from "@powershow/document-schema";
...
type LegacyStyledElement = Exclude<PowerShowElement, ContainerElement | TextElement | TextboxElement>;
