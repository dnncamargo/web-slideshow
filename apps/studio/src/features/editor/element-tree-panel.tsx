          ...
          {slide.elements.map((element, index) => (
            <ElementTreeNode
              ...
              onDragStart={(element, event) => {
                if (disableMovement || !isElementMovable(element.id) || (workspaceRootContainerId !== undefined && element.id === workspaceRootContainerId)) return;
              ...
              onDragOver={(target, event) => {
                if (disableMovement || !dragSource || dragSource.kind === "element" && !isElementMovable(dragSource.elementId)) {
                  return;
                }
              ...
              onGalleryItemDragOver={(galleryId, itemIndex, event) => {
                if (disableMovement || !dragSource || !isElementMovable(galleryId) || (dragSource.kind === "gallery-item" && !isElementMovable(dragSource.galleryId))) return;
              ...
              onMoveTableColumn={onMoveTableColumn}
              onMoveTableRow={onMoveTableRow}
              isDraggable={!disableMovement && isElementMovable(element.id) && (workspaceRootContainerId === undefined || element.id !== workspaceRootContainerId)}
        ...
        <button
          ...
          disabled={
            ...
            currentSelectedTableStructuralNode?.kind === "column"
              ...
              : selectedTopicItemPosition
                ? !selectedStructuralElementMovable || selectedTopicItemPosition.index === selectedTopicItemPosition.count - 1
