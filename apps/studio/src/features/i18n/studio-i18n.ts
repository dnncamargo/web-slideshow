...
const englishMessages = {
  ...
  "library.newFolderUnavailable": "Folders are not available yet.",
  "library.destination.archived": "Archived presentations are not available in this workspace yet.",
...
const portugueseMessages = {
  ...
  "library.newFolderUnavailable": "As pastas ainda não estão disponíveis.",
  "library.destination.archived": "As apresentações arquivadas ainda não estão disponíveis neste espaço.",
