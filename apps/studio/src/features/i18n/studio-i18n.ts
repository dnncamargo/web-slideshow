...
const englishMessages = {
  ...
  "library.importUnavailable": "Importing presentations is not available yet.",
  "library.export": "Export",
  "library.exportUnavailable": "Exporting presentations is not available yet.",
...
const portugueseMessages = {
  ...
  "library.importUnavailable": "A importação de apresentações ainda não está disponível.",
  "library.export": "Exportar",
  "library.exportUnavailable": "A exportação de apresentações ainda não está disponível.",
