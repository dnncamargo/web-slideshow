...
const englishMessages = {
  ...
  "inspector.fontSource": "Source",
  "inspector.fontsource": "Fontsource",
  "inspector.googleFonts": "Google Fonts",
  "inspector.manualFontSource": "Manual",
  "inspector.searchFonts": "Search web fonts",
  "inspector.searchingFonts": "Searching...",
  "inspector.noFontsFound": "No fonts found.",
  "inspector.googleFontsNotConfigured": "Google Fonts is not configured.",
  "inspector.couldNotSearchFonts": "Could not search fonts.",
  "inspector.couldNotLoadFontFamily": "Could not load this font family.",
  "inspector.fontSearchResults": "Results",
  "inspector.selectFont": "Select",
  "inspector.loadingFontFamily": "Loading family...",
  "inspector.selectedFontFamily": "Selected family",
  "inspector.webFontSubset": "Subset",
  "inspector.addToPresentation": "Add to presentation",
  "inspector.alreadyRegistered": "Already registered",
  "inspector.faceAlreadyRegistered": "Face already registered",
...
const portugueseMessages = {
  ...
  "inspector.fontSource": "Fonte",
  "inspector.fontsource": "Fontsource",
  "inspector.googleFonts": "Google Fonts",
  "inspector.manualFontSource": "Manual",
  "inspector.searchFonts": "Pesquisar fontes da web",
  "inspector.searchingFonts": "Pesquisando...",
  "inspector.noFontsFound": "Nenhuma fonte encontrada.",
  "inspector.googleFontsNotConfigured":
    "Google Fonts não está configurado.",
  "inspector.couldNotSearchFonts": "Não foi possível pesquisar fontes.",
  "inspector.couldNotLoadFontFamily":
    "Não foi possível carregar esta família de fonte.",
  "inspector.fontSearchResults": "Resultados",
  "inspector.selectFont": "Selecionar",
  "inspector.loadingFontFamily": "Carregando família...",
  "inspector.selectedFontFamily": "Família selecionada",
  "inspector.webFontSubset": "Subconjunto",
  "inspector.addToPresentation": "Adicionar à apresentação",
  "inspector.alreadyRegistered": "Já registrada",
  "inspector.faceAlreadyRegistered": "Face já registrada",
