        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "A resolução efetiva é: associação explícita do Slide → Presentation default → nenhum Root. Ao limpar uma associação explícita, a opção exibida é Use Presentation default quando houver uma Presentation default; isso não significa necessariamente ficar sem Root: o Slide volta a resolver a Presentation default quando ela existir.",
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "Elementos pertencentes a uma Root Definition podem referenciar Linked Styles e Text Styles da Presentation. As referências permanecem referências: alterar um Linked Style pode atualizar elementos master da Root que o usam, e alterar um Text Style pode atualizar textos master que o usam. Estilos referenciados por uma Root contam como em uso, podem aparecer na navegação de Reuse / Reutilização e seguem as proteções normais do ciclo de vida de recursos.",
